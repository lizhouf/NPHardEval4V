...
def parser():
    ...
    parser.add_argument('--adapter_model_output_dir', type=str, default='../../safeAGI/safeAGI/running/pretrained_models/adapter')
    parser.add_argument('--whole_model_output_dir', type=str, default='../../safeAGI/safeAGI/running/pretrained_models/whole_model')
