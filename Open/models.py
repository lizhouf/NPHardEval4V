...
def run_mistral(text_prompt, model_name=None):
    ...
    if model_name is None:
        ...
        download_dir = '../../safeAGI/safeAGI/running/pretrained_models'
    else:
...
def run_phi_2(text_prompt, model_name=None):
    ...
    print('--------download_dir--------')
    print(download_dir)
    model = AutoModelForCausalLM.from_pretrained(download_dir, torch_dtype="auto", trust_remote_code=True, device_map='auto')
    tokenizer = AutoTokenizer.from_pretrained(download_dir, trust_remote_code=True, padding_side='left')
